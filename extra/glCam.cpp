...
GLvoid display(void) {
	...
	glTexCoord2f(1.0f, 0.0f); glVertex2f(frame_width-300, 0.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex2f(frame_width-300, frame_height-300);
	glTexCoord2f(0.0f, 1.0f); glVertex2f(0.0f, frame_height-300);
	glEnd();

	glColor3f (0.0, 1.0, 1.0);
	// Draw a line
	glBegin(GL_TRIANGLES);    
	   	glVertex3f(frame_width, frame_height, 0);
	   	glVertex3f(frame_width-100, frame_height, 0);
	   	glVertex3f(frame_width, frame_height-100, 0);
	glEnd();
